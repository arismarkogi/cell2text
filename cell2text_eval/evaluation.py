...
def evaluate_cell2text_model(model: Cell2TextModel, 
    ...
    with torch.no_grad():
        ...
        if "description_input_ids" in batch and batch["description_input_ids"] is not None:
            ...
            # Create combined input and labels for loss calculation (same as training)
            ...
            try:
                ...
                if is_main_process:
                    ...
                    print(f"Combined input shape: {combined_input_ids.shape}")
                    print(f"Combined attention shape: {combined_attention_mask.shape}")
